...
class PaymentRepository {
  ...
  Future<bool> recordTrip(String saccoName, double amount, String from, String to) async {
  ...
  Future<void> recordTripWithoutDeduction(String saccoName, double amount, String from, String to) async {
      await Future.delayed(const Duration(milliseconds: 200));
      ...
      _history.insert(0, Payment(
          id: DateTime.now().millisecondsSinceEpoch.toString(),
          title: '$saccoName - $from to $to (M-Pesa)',
          amount: amount,
          date: DateTime.now(),
          isTopUp: false
      ));
